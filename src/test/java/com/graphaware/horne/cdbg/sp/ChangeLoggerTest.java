...
public class ChangeLoggerTest {
    ...
    public void setUp() {
        database = new TestGraphDatabaseFactory()
                ...
                //.setConfig(DBMS.security.procedures.))
                .newGraphDatabase();
...
/*
    ...
    public void ValidateAddressTest() {
    	org.neo4j.graphdb.Result result = database.execute("call example.ValidateAddress('28623 Blue Holly Ln', 'Katy', 'TX','77494')");
    	 assertThat( result.resultAsString(), equalTo( "test" ) );
